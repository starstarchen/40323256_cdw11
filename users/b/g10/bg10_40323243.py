...
bg10_40323243 = Blueprint('bg10_40323243', __name__, url_prefix='/bg10_40323243', template_folder='templates')
...
@bg10_40323243.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@bg10_40323243.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@bg10_40323243.route('/circle1/<x>/<degree>', defaults={'y': 0})
@bg10_40323243.route('/circle1/<x>/<y>/<degree>')
...
@bg10_40323243.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@bg10_40323243.route('/circle2/<x>/<degree>', defaults={'y': 0})
@bg10_40323243.route('/circle2/<x>/<y>/<degree>')
...
@bg10_40323243.route('/twocircle/<x>/<y>')
@bg10_40323243.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@bg10_40323243.route('/eighteenthirty/<x>/<y>')
@bg10_40323243.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@bg10_40323243.route('/snap')
...
'''
    return outstring
@bg10_40323243.route('/threegears', defaults={'n1':17,'n2':29,'n3':15,'n4':22})
@bg10_40323243.route('/threegears/<n1>/<n2>/<n3>/<n4>/')
def draw_threegears(n1, n2, n3, n4):
    outstring='''
<!DOCTYPE html>
<html>
<head>
